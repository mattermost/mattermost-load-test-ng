...
func clusterTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "cluster.tf", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
func outputsTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "outputs.tf", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
func variablesTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "variables.tf", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
