...
type Config struct {
	...
	LoadTestDownloadURL   string `default:"https://github.com/mattermost/mattermost-load-test-ng/releases/download/v1.19.0-rc2/mattermost-load-test-ng-v1.19.0-rc2-linux-amd64.tar.gz" validate:"url"`
