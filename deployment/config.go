...
type Config struct {
	...
	LoadTestDownloadURL   string `default:"https://github.com/mattermost/mattermost-load-test-ng/releases/download/v1.16.0/mattermost-load-test-ng-v1.16.0-linux-amd64.tar.gz" validate:"url"`
