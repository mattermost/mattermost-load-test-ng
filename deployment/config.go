...
type Config struct {
	...
	LoadTestDownloadURL   string `default:"https://github.com/mattermost/mattermost-load-test-ng/releases/download/v1.10.0-rc1/mattermost-load-test-ng-v1.10.0-rc1-linux-amd64.tar.gz" validate:"url"`
