...
func (c *SimpleController) createActions(definitions []actionDefinition) error {
	...
	actionMap := map[string]control.UserAction{
		...
		"RandomSearchPosts":           control.RandomSearchPosts,
		"SearchPostOperatorFrom":      control.SearchPostOperatorFrom,
		"SearchPostOperatorInChannel": control.SearchPostOperatorInChannel,
		"SearchPostOperatorExclude":   control.SearchPostOperatorExclude,
		"SearchHashtag":               control.SearchHashtag,
