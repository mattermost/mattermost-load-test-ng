// Code generated for package report by go-bindata DO NOT EDIT. (@generated)
// sources:
// assets/comparison.tmpl.json
package report
...
func comparisonTmplJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "comparison.tmpl.json", size: 0, mode: os.FileMode(420), modTime: time.Unix(0, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"comparison.tmpl.json": &bintree{comparisonTmplJson, map[string]*bintree{}},
}}
