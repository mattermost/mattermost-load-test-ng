...
require (
	...
	github.com/mattermost/mattermost-server/v6 v6.0.0-20230316165000-7804debb7f76
...
require (
	...
	github.com/mattermost/focalboard/server v0.0.0-20230404192949-dc0e664df90e // indirect
