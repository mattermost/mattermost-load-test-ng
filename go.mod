...
require (
	...
	github.com/mattermost/mattermost/server/public v0.2.2-0.20260319165039-d5fdc1f534ff
	github.com/mattermost/mattermost/server/v8 v8.0.0-20260323113040-156bdc5fa643
